...
* 📲 [MediaServer](https://github.com/limitedeternity/MediaServer) – приложение, позволяющее поделиться содержимым папки с мультимедиа в локальной сети. Можно дать кому-нибудь послушать свою многотонную аудиотеку или смешные видосики, которые ты кропотливо сохранял на телефоне.
...
## 🔭 Чему я научился в универе?

- Писать на Haskell. Вот, например, программы для построения таблиц истинности, конструирования полиномов Жегалкина и поиска отношений между множествами: https://github.com/limitedeternity/some-gists/tree/master/RelationalAlgebra
...
- Научился работать с Transact-SQL и в целом работать с языком запросов: https://github.com/limitedeternity/SQL-Labs
...
- Осуществлять поддержку других open-source проектов: https://github.com/lex-js/lex-js.<br>Переписал проект сначала на Node.js, а затем на Python, настроил CI-среду с автоматической сборкой проекта в исполняемый PE-файл под две разные архитектуры.
