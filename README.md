...
* Обитаю на [**HackTheBox**](https://app.hackthebox.eu/profile/369200).
...
– Исследователь, энтузиаст, ответственный командный игрок, любящий поддерживать других знанием и делом. И турист =)
