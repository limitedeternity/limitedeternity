...
* 🧬 [FASTAUtils](https://github.com/limitedeternity/FASTAUtils): веб-приложение, написанное по просьбе знакомого генного инженера. Принимает на вход цепочку ДНК в формате FASTA и разбивает её на более мелкие фрагменты с пересечениями. Учитывает максимальную допустимую длину фрагментов, а также температуру плавления и размер их пересечений.

### Rust

* 🖥 [Yanes](https://github.com/limitedeternity/yanes): виртуальная машина, эмулирующая процессор 6502. Есть адресное пространство, дисплей, возможность ввода с клавиатуры и ассемблер. Дипломная работа.
...
* 🐍 [pyenv-py](https://github.com/limitedeternity/pyenv-py): лаунчер для [**pyenv-win**](https://github.com/pyenv-win/pyenv-win) – менеджера версий Python, позволяющего устанавливать и использовать несколько версий Python одновременно на одной системе. Запускает различные версии Python из списка установленных без необходимости переключаться на них.
